    ...
    <div class="container mt-4 center-content no-height">
        <div class="card glass">
            ...
            <div class="info-row mb-4" style="background: #f9fafb; padding: 15px; border-radius: 8px;">
                <p class="text-sm text-muted mb-2"><strong>Booking ID:</strong> <?php echo htmlspecialchars($booking['booking_id']); ?></p>
                <p class="text-sm text-muted mb-2"><strong>Patient:</strong> <?php echo htmlspecialchars($booking['patient_name']); ?></p>
                <p class="text-sm text-muted"><strong>Doctor:</strong> Dr. <?php echo htmlspecialchars($booking['doctor_name']); ?> (<?php echo htmlspecialchars($booking['specialty']); ?>)</p>
            </div>
            ...
            <form action="edit_appointment.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" required min="<?php echo date('Y-m-d'); ?>" value="<?php echo isset($_POST['date']) ? $_POST['date'] : $booking['date']; ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="details" rows="3"><?php echo htmlspecialchars(isset($_POST['details']) ? $_POST['details'] : $booking['details']); ?></textarea>
                </div>

                <button type="submit" class="btn primary-btn mt-2 block-btn">Save Changes</button>
                <a href="appointments.php" class="btn mt-2 block-btn text-center" style="background:#e5e7eb; color:#374151;">Cancel</a>
            </form>
            <?php endif; ?>
        </div>
    </div>
